  ...
  return (
    <div className="py-64 md:py-80 ">
      <div className="justify-between md:flex items-center">
        <div className="text-heading-2-mobile md:text-heading-2 font-syne md:w-485">
          Comfort Is Our Top Priority For You
        </div>
        <div className="pt-16 md:pt-0 text-lg-regular flex md:w-462 text-secondary-dark-80">
      ...
      <div
        className="pt-32 md:pt-64 gap-32 w-full md:flex"
      >
